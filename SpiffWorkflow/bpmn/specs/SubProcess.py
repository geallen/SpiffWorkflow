...
class SubProcess(SubWorkflow, BpmnSpecMixin):
    """
    ...
    def __init__(self, parent, name, wf_spec=None, wf_class=None, **kwargs):
        ...
        """
        super(SubProcess, self).__init__(parent, name, None, **kwargs)
        self.spec = wf_spec
    ...
    def _on_subworkflow_completed(self, subworkflow, my_task):
        super(SubProcess, self)._on_subworkflow_completed(subworkflow, my_task)
